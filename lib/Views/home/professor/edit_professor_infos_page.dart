...
class EditProfessorInfosPage extends StatefulWidget {
  const EditProfessorInfosPage({super.key});

  @override
  State<EditProfessorInfosPage> createState() => _EditProfessorInfosPageState();
}

class _EditProfessorInfosPageState extends State<EditProfessorInfosPage> with EditUserStateHelpers<EditProfessorInfosPage> {
